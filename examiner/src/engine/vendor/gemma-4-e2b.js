 ...
 *
 * Source: Hugging Face Space "webml-community/gemma-4-webgpu-kernels"
 *   https://huggingface.co/spaces/webml-community/gemma-4-webgpu-kernels/blob/main/gemma-4-e2b.js
 * Fetched: 2026-06-24
 *
 * A self-contained WebGPU runtime for Google's Gemma 4 E2B (QAT-mobile) model,
 * exporting `Gemma4Mobile`. Used by engine/gemma4.js because Gemma 4's
 * block-quantized weights cannot run on the onnxruntime-web bundled with
 * transformers.js. Fetches model weights from huggingface.co at runtime.
 *
 * LICENSE: the upstream Space declares no license. Retained here on the user's
 * explicit instruction. Review before redistribution.
 */
